  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          productColour: urlParams.singleProductColorId,
          productPrice: urlParams.singleProductPriceId,
          productSize: urlParams.singleProductSizeId,
          productRating: urlParams.singleProductRatingId,
          category: urlParams.singleCategoryId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
