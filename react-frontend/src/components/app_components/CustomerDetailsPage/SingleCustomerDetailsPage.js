...
const SingleCustomerDetailsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .then((res) => {
        set_entity(res || {});
        const customerAddress = Array.isArray(res.customerAddress)
          ? res.customerAddress.map((elem) => ({
              _id: elem._id,
            ...
            ? [
                {
                  ...
                  addressType: res.customerAddress.addressType,
                },
              ]
            : [];
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.customers}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
