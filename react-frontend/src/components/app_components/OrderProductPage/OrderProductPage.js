    ...
    client
      ...
      .find({
        query: {
          ...
          quantity: urlParams.singleItemsId,
          selectedColor: urlParams.singleProductColorId,
          selectedSize: urlParams.singleProductSizeId,
          unitPrice: urlParams.singleProductPriceId,
          orderNumber: urlParams.singleCheckoutId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
